...
class MoreKosAdapter(private val kosList: ArrayList<Kos>, private val context: Context):
    RecyclerView.Adapter<MoreKosAdapter.ViewHolder>() {

    inner class ViewHolder(val binding: KosCardLayoutBinding) : RecyclerView.ViewHolder(binding.root)


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MoreKosAdapter.ViewHolder {
